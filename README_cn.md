...
[![记忆产品](https://img.shields.io/badge/memory%20products-39-purple.svg)](products/)
...
| full / seed 论文笔记 | 7 个 full + 26 个 seed | [`papers/`](papers/) | 为架构决策引用人工阅读笔记。 |
| 记忆产品笔记 | 39 个笔记 | [`products/`](products/) | 对比 memory layer、memory SDK、managed memory 和带记忆的 agent 产品。 |
| 产品页面快照 | 38 个快照 | [`products/archives/`](products/archives/) | 在源页面变化后审计产品 claims。 |
| Benchmark 目录 | 22 个 catalog 行 | [`benchmarks/index.md`](benchmarks/index.md) | 理解 memory benchmark、stub-backed 候选行及其 claims 来源。 |
...
| 路径 | 用途 |
|---|---|
| [`products/`](products/) | 39 个记忆产品笔记，包括 Mem0、Letta、Zep、Graphiti、EverOS、MemOS、Redis Agent Memory Server、Supermemory、TencentDB Agent Memory、agentmemory、Memori、memU、memsearch、Databricks Managed Agent Memory 和平台 managed memory 等。 |
| [`products/archives/`](products/archives/) | 38 个记忆产品 canonical 页面 markdown 快照。 |
...
| 路径 | 用途 |
|---|---|
| [`papers/`](papers/) | 7 个 full 论文笔记、26 个 seed 笔记和主索引 [`index.md`](papers/index.md)。 |
...
| [`benchmarks/`](benchmarks/) | 22 个 benchmark catalog 行，包含协议笔记、stub-backed 候选行和笔记模板。 |
