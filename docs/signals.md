...
|---|---|---|---|---|
| 2026-07-27 | [Retain/Consolidate](https://arxiv.org/abs/2607.17545) / [AGMR](https://arxiv.org/abs/2607.17621) / [AttriMem](https://arxiv.org/abs/2607.21106) / [Beyond Memory Leaderboards](https://arxiv.org/abs/2607.16848) / [MemTools](https://arxiv.org/abs/2607.21404) | paper | 周更 radar 追加 budget-dependent memory operators、attention-guided refinement、attribution-guided writes、budgeted scientific-memory evaluation、memory interop framework | `seed-note` ✅(见 `papers/`) |
| 2026-07-27 | [Forged Reasoning Attacks](https://arxiv.org/abs/2607.05029) / [From Memory to Skills](https://arxiv.org/abs/2607.16621) / [Proactive Memory Agent](https://arxiv.org/abs/2607.08716) / [OCR-Memory](https://aclanthology.org/2026.acl-long.474/) / [Profile-Graph Memory](https://arxiv.org/abs/2607.19359) / [MOSAIC](https://arxiv.org/abs/2607.16211) | paper | 本轮补充 memory security、evidence-grounded skill promotion、proactive intervention、OCR artifact retrieval、profile graph 和 conflict-aware graph memory | `seed-note` ✅(见 `papers/`) |
| 2026-07-27 | [Memora](https://arxiv.org/abs/2604.20006) / [`geniesinc/Memora`](https://github.com/geniesinc/Memora) | paper | benchmark catalog 新增 weeks-to-months personalized memory 与 forgetting-aware FAMA 指标 | `seed-note` ✅([`../benchmarks/memora.md`](../benchmarks/memora.md)) |
| 2026-07-27 | [Databricks Managed Agent Memory](https://learn.microsoft.com/en-us/azure/databricks/agents/agent-memory/managed-memory) / [Google release notes](https://docs.cloud.google.com/release-notes) / [Anthropic release notes](https://docs.anthropic.com/en/release-notes/api) / [OpenAI Projects](https://help.openai.com/en/articles/10169521-projects-in-chatgpt) / [Letta trajectory](https://www.letta.com/blog/trajectory/) | product | 官方源补充 Databricks beta managed memory、Google profiles/IngestEvents GA、Claude memory-store header、OpenAI project scope 和 Letta trajectory signal | `deep-note` ✅(更新 `products/`) |
