...
|---|---|---|---|---|
| 2026-08-10 | [LeanMem](https://arxiv.org/abs/2608.03463) / [MemSIF](https://arxiv.org/abs/2608.01742) / [VerMem](https://arxiv.org/abs/2608.03137) / [HiGram](https://arxiv.org/abs/2608.05095) / [MemoryCPT](https://arxiv.org/abs/2608.04843) / [RoMeRL](https://arxiv.org/abs/2608.02508) / [MutMem](https://arxiv.org/abs/2608.02843) | paper | 周更 radar 追加 typed memory lanes、dual-track facts、verifier-trained memory operations、hierarchical graph rewrite、cost-performance training、reduced-order utility 和 signed mutation 七条 seed note | `seed-note` ✅(见 `papers/`) |
| 2026-08-10 | [Router-Mem](https://arxiv.org/abs/2608.01285) / [V-Mem](https://arxiv.org/abs/2608.01543) / [Salami Attack](https://arxiv.org/abs/2608.01637) / [Memory Reward Inflation](https://arxiv.org/abs/2608.00017) / [StateAuditor](https://arxiv.org/abs/2608.01619) / [MERIT](https://arxiv.org/abs/2608.05906) | paper | 周更 radar 追加 evidence-sufficiency routing、多模态 routed recall、collusive memory poisoning、reward inflation、stale-dependency audit 和 task-repair episodic memory 六条 seed note | `seed-note` ✅(见 `papers/`) |
| 2026-08-10 | [AgentMemBench](https://arxiv.org/abs/2608.00009) / [FinPerMA](https://arxiv.org/abs/2608.04095) / [AuthMem-Bench](https://arxiv.org/abs/2608.01679) | paper | benchmark catalog 新增 memory strategy、event-grounded personalization 和 source-authority collapse 三个 origin protocol | `seed-note` ✅(见 `benchmarks/`) |
| 2026-08-10 | [Microsoft Foundry Memory usage guide](https://learn.microsoft.com/en-us/azure/foundry/agents/how-to/memory-usage) / [AWS AgentCore release notes](https://docs.aws.amazon.com/bedrock-agentcore/latest/devguide/release-notes.html) | product | 官方产品源补充 Foundry Memory CRUD/TTL/scope/remember-forget 和 AgentCore GovCloud 可用性;均为产品行为证据,不是性能证据 | `deep-note` ✅(更新 `products/`) |
