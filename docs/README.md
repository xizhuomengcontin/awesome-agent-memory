...
4. [`weekly-memory-refresh-runbook.md`](weekly-memory-refresh-runbook.md) —
   ...
   benchmarks.
5. [`memory-radar-2026-09-14.md`](memory-radar-2026-09-14.md) — latest current-source
...
| [`memory-radar-2026-09-14.md`](memory-radar-2026-09-14.md) | 2026-09 weekly refresh with must-add, update-existing, watchlist, adjacent, and reject decisions. |
