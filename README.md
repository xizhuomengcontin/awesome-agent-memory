...
| Full / seed paper notes | 7 full + 28 seed | [`papers/`](papers/) | Use human-read notes for architectural decisions. |
...
| Path | Purpose |
|---|---|
| [`papers/`](papers/) | 7 full paper notes, 28 seed notes, and the master [`index.md`](papers/index.md). |
