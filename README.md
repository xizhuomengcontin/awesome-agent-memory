...
| Benchmark catalog | 24 catalog rows | [`benchmarks/index.md`](benchmarks/index.md) | First-class benchmark records plus stub-backed candidate rows and a usage-claim ledger. |
...
| Read the latest source refresh | [`docs/memory-radar-2026-09-07.md`](docs/memory-radar-2026-09-07.md), then [`docs/signals.md`](docs/signals.md) |
...
| [`docs/memory-radar-2026-09-07.md`](docs/memory-radar-2026-09-07.md) | 2026-09-07 weekly refresh across papers, benchmarks, products, GitHub discovery, and reviewer decisions. |
...
| [`benchmarks/`](benchmarks/) | 24 benchmark catalog rows, including protocol notes, stub-backed candidate rows, and the note template. |
